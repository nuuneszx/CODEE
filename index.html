                ...
                <div class="col-md-8 col-lg-10 rounded-5 formulario"> <!-- Caixa do formulário com 60% de largura -->
                    ...
                    <form>
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="nome" name="nome" class="form-control rounded-3 mt-1"Collapse commentComment on line R103jotalima7 commented on Aug 26, 2025 jotalima7on Aug 26, 2025More actionsjoaoWrite a replyCode has comments. Press enter to view.
